	...
	return (
		<Box
			...
			sx={{
				...
				left: 0,
				transition: 'all 0.3s',
				transform: playerOverlayIsOpen ? 'translateY(0px) scaleY(1)' : 'translateY(100vh) scaleY(0)'
			}}
		>
			<Container sx={{ height: '100%', background: 'linear-gradient(0deg, #121212 0%, #39d37250 100%);' }}>
